		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="hr_book_form">
			...
			<div class="left">
				...
				<div class="form_group">
					...
					<label>Date</label>
					<input type="date" name="date_res" placeholder="Select date for booking" min="<?php echo date('y-m-d'); ?>"  required>
...
<div class="footer_parallax" onclick="remove_class()">
	...
	<div class="on_footer_parallax">
		...
		<p>&copy; <?php echo strftime("%Y", time()); ?> <span>bnmcafe</span>. All Rights Reserved</p>
